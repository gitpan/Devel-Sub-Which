...
sub import {
	...
	@_ = ($pkg, grep { not ($universal ||= $_ eq ":universal") } @_);
...
Devel::Sub::Which - Name information about sub calls a lá ->can.
...
Often I find myself faced with polymorphism crap flying into my face. With
...
using L<UNIVERSAL::can> (or any overridding implementation), 
